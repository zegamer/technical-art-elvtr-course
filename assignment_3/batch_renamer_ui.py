...
class Ui_main_window(object):
    ...
    def retranslateUi(self, main_window):
        ...
        main_window.setWindowTitle(_translate("main_window", "File renamer"))
        self.option_group.setTitle(_translate("main_window", "Options"))
        self.file_path_label.setText(_translate("main_window", "Folder Path"))
        self.file_path_line_edit.setToolTip(_translate("main_window", "File path of the file you want to rename"))
        self.browse_button.setToolTip(_translate("main_window", "Browse the file"))
        self.browse_button.setText(_translate("main_window", "Browse"))
        self.mode_label.setText(_translate("main_window", "Mode"))
        self.rename_radio_button.setToolTip(_translate("main_window", "Replace the files with the new name"))
        self.rename_radio_button.setText(_translate("main_window", "Rename"))
        self.copy_radio_button.setToolTip(_translate("main_window", "Copy the files with the new name"))
        self.copy_radio_button.setText(_translate("main_window", "Copy"))
        self.prefix_label.setText(_translate("main_window", "Prefix"))
        self.prefix_line_edit.setToolTip(_translate("main_window", "Prefix for file name"))
        self.suffix_label.setText(_translate("main_window", "Suffix"))
        self.suffix_line_edit.setToolTip(_translate("main_window", "Suffix for the file name"))
        self.string_to_find_label.setText(_translate("main_window", "String to find"))
        self.string_to_find_line_edit.setToolTip(_translate("main_window", "Comma separated strings in file name that you want to replace"))
        self.string_to_replace_label.setText(_translate("main_window", "String to replace"))
        self.string_to_replace_line_edit.setToolTip(_translate("main_window", "Replacement string"))
        self.extension_label.setText(_translate("main_window", "Extensions"))
        self.extension_drop_down.setToolTip(_translate("main_window", "The file type you want to modify"))
        self.extension_drop_down.setItemText(0, _translate("main_window", "all"))
        self.run_button.setToolTip(_translate("main_window", "Run the renamer"))
        self.run_button.setText(_translate("main_window", "Run"))
        self.reset_button.setToolTip(_translate("main_window", "Reset all inputs"))
        self.reset_button.setText(_translate("main_window", "Reset"))
        self.file_view_list_widget.setToolTip(_translate("main_window", "Shows the list of files to rename"))
